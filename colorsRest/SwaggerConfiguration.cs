public static class SwaggerConfiguration
{
    ...
    public static string EndpointDescription { get { return "Colors API v1"; } }
    ...
    public static string DocInfoDescription { get { return "Colors Api - Colors Web API in ASP.NET Core 2"; } }
}